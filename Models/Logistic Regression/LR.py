...
# Plot feature importance
weights = abs(logistic_regression_model.coef_[0])
names = X.columns
plot_feature_importance(weights, names, 'Logistic Regression')

# Plot learning curve
plot_learning_curve(logistic_regression_model, X_train_scaled, y_train, 'Logistic Regression')
