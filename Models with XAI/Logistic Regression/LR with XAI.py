...
exp = explainer.explain_instance(X_test_scaled[instance_index], logistic_regression_model.predict_proba, num_features=len(X.columns))
...
feature_explanations = {
    ...
    "-0.73 < concave points_mean <= -0.39": "Fewer average concave points might indicate a smoother, less irregular tumor, often associated with benign cases.",
